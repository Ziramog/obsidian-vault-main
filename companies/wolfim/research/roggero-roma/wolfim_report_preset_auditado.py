...
class WolfimReport(FPDF):
    ...
    # ---------- cover ----------
    def add_cover(self, title: str, subtitle: str, client: str, period: str, prepared_for: str | None = None, date_label: str | None = None, cover_label: str = 'INFORME WOLFIM', cover_footer_text: str = 'Reporte preparado para convertir datos en decisiones comerciales concretas.'):
        self.add_page()
        ...
        self.cell(52, 4, cover_label.upper(), align='C')
        ...
        self.set_text_color(*self.color('gray_400'))
        self.multi_cell(128, 5.0, cover_footer_text)
        self.image(str(self.assets['logo_black']), x=151, y=247, w=43)
        self.set_y(270)
        self.set_x(16)
        self.set_font('MONO', '', 6.5)
        self.set_text_color(*self.color('gray_400'))
        self.cell(42, 4, 'CÓRDOBA, ARGENTINA')
        self.set_fill_color(*self.color('green'))
        self.ellipse(59.5, 271.2, 1.8, 1.8, 'F')
        self.set_x(64)
        self.cell(0, 4, 'SERVICIO REMOTO')

...
- No decir "hacemos páginas web"
- No usar genérico "mejorá tu presencia digital"
...
| Métrica | Herramienta |
|---------|-------------|
| Visitas a landing | Google Analytics / Meta Pixel |
| Costo por clic (CPC) | Meta Ads Manager |
| Costo por lead (CPL) | Meta + formulario propio |
| Consultas recibidas | WhatsApp + formulario |
